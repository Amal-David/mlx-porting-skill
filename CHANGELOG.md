...
- Added improvement bands, four optimization stacks, derived-never-stored compound ceilings flagged as multiplicative hypotheses, and advisor recommended-stack output.
...
- Initial portable Agent Skill for arbitrary-model MLX and MLX-Audio porting.
