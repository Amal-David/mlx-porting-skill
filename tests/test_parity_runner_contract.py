...
class ParityRunnerDependencyFreeContractTests(unittest.TestCase):
    ...
    def test_capture_mlx_accepts_vetted_dense_generator_1_0_1(self) -> None:
        with tempfile.TemporaryDirectory() as raw_tmp:
            ...
            self.assertEqual(state["manifest"]["generator"]["version"], "1.0.1")
