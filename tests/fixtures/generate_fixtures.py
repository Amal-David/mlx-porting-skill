...
MODEL_SPECS: dict[str, dict[str, Any]] = {
    ...
    "time_series_forecasting": {
        ...
        "tensors": {
            "past_value_embedding.weight": ("F16", [8, 1]),
            "time_feature_projection.weight": ("F16", [8, 3]),
            "encoder.layers.0.self_attn.q_proj.weight": ("F16", [8, 8]),
            "decoder.layers.0.self_attn.q_proj.weight": ("F16", [8, 8]),
            "distribution_projector.proj.weight": ("F16", [3, 8]),
            "scaler.loc": ("F32", [1]),
        },
    },
    "encoder_decoder": {
