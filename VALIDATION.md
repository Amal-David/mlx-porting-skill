...
| The deep research loop emits review-only assignments, planned multi-source sampling, blogs, synthesis, executor receipts, and rejects malformed findings | `test_research_loop_*` |
