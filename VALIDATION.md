...
| The deep research loop emits review-only assignments, dynamic assignment-planner receipts, planned multi-source sampling, blogs, synthesis, executor receipts, and rejects malformed findings | `test_research_loop_*` |
...
- Live execution of external research subagents or network collectors; offline tests cover the harness contract, fixture ingestion, and contributor collector receipt behavior only.
