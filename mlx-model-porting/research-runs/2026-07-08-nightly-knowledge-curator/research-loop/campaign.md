# Research Campaign 2026-07-08-nightly-knowledge-curator-research-loop
...
## Waves
- Wave 1: 2026-07-08-nightly-knowledge-curator-research-loop (6 agents)
  - output: .
  - subagents: subagents.json
  - assignment mode: dynamic
  - gap hints: multi, research, sampling, codex, openai
  - next gap hints: https, packages, papers, repositories, github, search, explore, ml, hugging_face, metadata
  - ingest command args: python3 scripts/research_loop.py --run-id 2026-07-08-nightly-knowledge-curator-research-loop --objective 'Nightly MLX knowledge curator: top contributors, papers, blogs, package releases, model outcomes, speedup ranges, and app/CLI skill deltas' --agent-count 6 --assignment-mode dynamic --gap-hint multi --gap-hint research --gap-hint sampling --gap-hint codex --gap-hint openai --min-sampled-targets 6 --min-non-github-lanes 4 --require-source-lane papers --require-source-lane repositories --require-source-lane repo_local_audit --ingest-subagent-results --output-dir research-runs/2026-07-08-nightly-knowledge-curator/research-loop
