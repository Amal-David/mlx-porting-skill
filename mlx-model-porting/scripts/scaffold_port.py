...
python3 capture.py --weights converted.safetensors --token-ids 1 42 17 --generate-steps 4 --output target.npz
python3 ../scripts/compare_tensors.py source-oracle.npz target.npz
```
