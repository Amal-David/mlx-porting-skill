...
MoE by a synthetic gate. Other families remain runbook-guided. Exact
...
For an unblocked `dense-decoder-transformer` or supported
`moe-decoder-transformer` inspection, scaffold implementation:
